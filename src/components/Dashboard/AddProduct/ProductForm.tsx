...
//     images: z
//         .array(z.string().url("Please provide a valid URL for each image")) // Ensure each item is a valid URL
//         .length(3, "You must upload exactly 3 images"),
...
//                                             {/* Image Preview */}
//                                             <Image
//                                                 src={URL.createObjectURL(file)} // Use the file object to create a preview URL
