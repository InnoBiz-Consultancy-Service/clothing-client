...
//           Everything you need to know about our products, policies, and promises. Can not find what you are looking for? Contact our style experts.
//         </p>
//       </div>

//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
//         {faqData.map((faq, index) => (
//           <div key={index} className="bg-white rounded-xl shadow-sm hover:shadow-md border border-gray-100">
...
//       </div>
//       {/* Lower Banner */}
//       <div className="mt-16 bg-gradient-to-r from-indigo-50 to-rose-50 rounded-2xl p-8 text-center shadow-sm">
